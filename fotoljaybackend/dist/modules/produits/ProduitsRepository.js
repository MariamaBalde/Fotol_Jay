import { StatutProduit, Prisma } from '@prisma/client';
...
export class ProduitsRepository {
    ...
    async ajouterImages(produitId, images) {
    ...
    async lister(filtres) {
        const { categorie, prixMin, prixMax, etat, recherche, page = 1, limite = 20, statut = StatutProduit.APPROUVE, utilisateurId, } = filtres;
    ...
    // Modérer un produit
    async moderer(id, statut, raisonRefus) {
        return await prisma.produit.update({
            where: { id },
            data: {
                statut,
...
//# sourceMappingURL=ProduitsRepository.js.map